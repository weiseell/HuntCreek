...
#ABOUT: This script was written to evaluate the accuracy of
#colony parent assignments involving small half-sibling families

#setting working directory
setwd("Power_Analysis/")

#getting the list of best config files
