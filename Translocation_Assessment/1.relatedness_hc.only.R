...
#setwd("C:/Users/knsar/Google Drive/R/Data analysis/2017/Hunt Creek/Relatedness randomization/")
...
for(i in 1:250){
  ...
  mat.str <- brd.mat(moms = n.mom,dads = n.dad,min.mates = 1,max.mates = 1,min.fert = 1,max.fert = 8)
  #head(mat.str)
 ...
 #writing to file
  write.table(x = tmp4,file = "output/randomized.hunt.creek.offspring.0.txt",append = T,quote = F,sep = "\t",row.names = F,col.names = T)
}
